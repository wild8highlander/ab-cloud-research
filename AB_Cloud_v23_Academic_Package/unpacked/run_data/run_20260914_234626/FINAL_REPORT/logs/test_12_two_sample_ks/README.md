# `logs/test_12_two_sample_ks/` — Raw Log Copies of Test 12 (Provenance Set)

This folder is part of FINAL_REPORT's provenance layer: it preserves the **raw computation log and console capture of Test 12** exactly as the reference run wrote them. The reading copies — with the full test description, verdicts and excerpts — live in the test's own folder: [`../../test_12_two_sample_ks/`](../../test_12_two_sample_ks/README.md).
...
|---|---|---|
| `computation_log_XX.txt` | 134 B · 4 lines | Timestamped computation log: every log_comp() entry emitted while the test ran, with wall-clock offsets. |
| `stdout_capture_XX.txt` | 1.1 KB · 12 lines | Raw console capture: the suite's console output for this test, including lettered sub-check lines and the verdict block. |
...
---
_Package overview: [unpacked/](../../../../README.md) · FINAL_REPORT: [../](../README.md) · Test folder: [../../test_12_two_sample_ks/](../../test_12_two_sample_ks/README.md)_
