# `logs/test_02_bN_monotonicity/` — Raw Log Copies of Test 2 (Provenance Set)

This folder is part of FINAL_REPORT's provenance layer: it preserves the **raw computation log and console capture of Test 2** exactly as the reference run wrote them. The reading copies — with the full test description, verdicts and excerpts — live in the test's own folder: [`../../test_02_bN_monotonicity/`](../../test_02_bN_monotonicity/README.md).
...
| `stdout_capture_XX.txt` | 1.4 KB · 24 lines | Raw console capture: the suite's console output for this test, including lettered sub-check lines and the verdict block. |
...
---
_Package overview: [unpacked/](../../../../README.md) · FINAL_REPORT: [../](../README.md) · Test folder: [../../test_02_bN_monotonicity/](../../test_02_bN_monotonicity/README.md)_
