# `logs/test_24_dirac_string_flux/` — Raw Log Copies of Test 24 (Provenance Set)

This folder is part of FINAL_REPORT's provenance layer: it preserves the **raw computation log and console capture of Test 24** exactly as the reference run wrote them. The reading copies — with the full test description, verdicts and excerpts — live in the test's own folder: [`../../test_24_dirac_string_flux/`](../../test_24_dirac_string_flux/README.md).
...
|---|---|---|
| `computation_log_XX.txt` | 642 B · 7 lines | Timestamped computation log: every log_comp() entry emitted while the test ran, with wall-clock offsets. |
| `stdout_capture_XX.txt` | 1.4 KB · 17 lines | Raw console capture: the suite's console output for this test, including lettered sub-check lines and the verdict block. |
...
---
_Package overview: [unpacked/](../../../../README.md) · FINAL_REPORT: [../](../README.md) · Test folder: [../../test_24_dirac_string_flux/](../../test_24_dirac_string_flux/README.md)_
