# `logs/test_37_half_factorial_gamma/` — Raw Log Copies of Test 37 (Provenance Set)

This folder is part of FINAL_REPORT's provenance layer: it preserves the **raw computation log and console capture of Test 37** exactly as the reference run wrote them. The reading copies — with the full test description, verdicts and excerpts — live in the test's own folder: [`../../test_37_half_factorial_gamma/`](../../test_37_half_factorial_gamma/README.md).
...
|---|---|---|
| `computation_log_XX.txt` | 162 B · 4 lines | Timestamped computation log: every log_comp() entry emitted while the test ran, with wall-clock offsets. |
| `stdout_capture_XX.txt` | 1.4 KB · 15 lines | Raw console capture: the suite's console output for this test, including lettered sub-check lines and the verdict block. |
...
---
_Package overview: [unpacked/](../../../../README.md) · FINAL_REPORT: [../](../README.md) · Test folder: [../../test_37_half_factorial_gamma/](../../test_37_half_factorial_gamma/README.md)_
