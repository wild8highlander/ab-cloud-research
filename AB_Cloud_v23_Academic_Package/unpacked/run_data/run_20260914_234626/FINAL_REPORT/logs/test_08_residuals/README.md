# `logs/test_08_residuals/` — Raw Log Copies of Test 8 (Provenance Set)

This folder is part of FINAL_REPORT's provenance layer: it preserves the **raw computation log and console capture of Test 8** exactly as the reference run wrote them. The reading copies — with the full test description, verdicts and excerpts — live in the test's own folder: [`../../test_08_residuals/`](../../test_08_residuals/README.md).
...
|---|---|---|
| `computation_log_XX.txt` | 133 B · 4 lines | Timestamped computation log: every log_comp() entry emitted while the test ran, with wall-clock offsets. |
...
---
_Package overview: [unpacked/](../../../../README.md) · FINAL_REPORT: [../](../README.md) · Test folder: [../../test_08_residuals/](../../test_08_residuals/README.md)_
