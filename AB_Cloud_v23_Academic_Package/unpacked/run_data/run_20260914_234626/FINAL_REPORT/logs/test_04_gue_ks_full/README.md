# `logs/test_04_gue_ks_full/` — Raw Log Copies of Test 4 (Provenance Set)

This folder is part of FINAL_REPORT's provenance layer: it preserves the **raw computation log and console capture of Test 4** exactly as the reference run wrote them. The reading copies — with the full test description, verdicts and excerpts — live in the test's own folder: [`../../test_04_gue_ks_full/`](../../test_04_gue_ks_full/README.md).
...
|---|---|---|
| `computation_log_XX.txt` | 1.2 KB · 14 lines | Timestamped computation log: every log_comp() entry emitted while the test ran, with wall-clock offsets. |
...
---
_Package overview: [unpacked/](../../../../README.md) · FINAL_REPORT: [../](../README.md) · Test folder: [../../test_04_gue_ks_full/](../../test_04_gue_ks_full/README.md)_
