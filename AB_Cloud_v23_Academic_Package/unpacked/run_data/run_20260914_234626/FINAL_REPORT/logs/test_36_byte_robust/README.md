# `logs/test_36_byte_robust/` — Raw Log Copies of Test 36 (Provenance Set)

This folder is part of FINAL_REPORT's provenance layer: it preserves the **raw computation log and console capture of Test 36** exactly as the reference run wrote them. The reading copies — with the full test description, verdicts and excerpts — live in the test's own folder: [`../../test_36_byte_robust/`](../../test_36_byte_robust/README.md).
...
|---|---|---|
| `computation_log_XX.txt` | 15.7 KB · 145 lines | Timestamped computation log: every log_comp() entry emitted while the test ran, with wall-clock offsets. |
| `stdout_capture_XX.txt` | 3.6 KB · 46 lines | Raw console capture: the suite's console output for this test, including lettered sub-check lines and the verdict block. |
...
---
_Package overview: [unpacked/](../../../../README.md) · FINAL_REPORT: [../](../README.md) · Test folder: [../../test_36_byte_robust/](../../test_36_byte_robust/README.md)_
