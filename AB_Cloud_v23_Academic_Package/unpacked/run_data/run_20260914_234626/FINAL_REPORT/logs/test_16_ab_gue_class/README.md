# `logs/test_16_ab_gue_class/` — Raw Log Copies of Test 16 (Provenance Set)

This folder is part of FINAL_REPORT's provenance layer: it preserves the **raw computation log and console capture of Test 16** exactly as the reference run wrote them. The reading copies — with the full test description, verdicts and excerpts — live in the test's own folder: [`../../test_16_ab_gue_class/`](../../test_16_ab_gue_class/README.md).
...
|---|---|---|
| `computation_log_XX.txt` | 1.3 KB · 13 lines | Timestamped computation log: every log_comp() entry emitted while the test ran, with wall-clock offsets. |
| `stdout_capture_XX.txt` | 1.3 KB · 18 lines | Raw console capture: the suite's console output for this test, including lettered sub-check lines and the verdict block. |
...
---
_Package overview: [unpacked/](../../../../README.md) · FINAL_REPORT: [../](../README.md) · Test folder: [../../test_16_ab_gue_class/](../../test_16_ab_gue_class/README.md)_
