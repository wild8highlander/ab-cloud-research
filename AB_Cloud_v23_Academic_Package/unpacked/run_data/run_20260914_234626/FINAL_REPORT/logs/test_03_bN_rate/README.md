# `logs/test_03_bN_rate/` — Raw Log Copies of Test 3 (Provenance Set)

This folder is part of FINAL_REPORT's provenance layer: it preserves the **raw computation log and console capture of Test 3** exactly as the reference run wrote them. The reading copies — with the full test description, verdicts and excerpts — live in the test's own folder: [`../../test_03_bN_rate/`](../../test_03_bN_rate/README.md).
...
---
_Package overview: [unpacked/](../../../../README.md) · FINAL_REPORT: [../](../README.md) · Test folder: [../../test_03_bN_rate/](../../test_03_bN_rate/README.md)_
