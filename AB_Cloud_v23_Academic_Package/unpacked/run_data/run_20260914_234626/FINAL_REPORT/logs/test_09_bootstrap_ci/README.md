# `logs/test_09_bootstrap_ci/` — Raw Log Copies of Test 9 (Provenance Set)

This folder is part of FINAL_REPORT's provenance layer: it preserves the **raw computation log and console capture of Test 9** exactly as the reference run wrote them. The reading copies — with the full test description, verdicts and excerpts — live in the test's own folder: [`../../test_09_bootstrap_ci/`](../../test_09_bootstrap_ci/README.md).
...
---
_Package overview: [unpacked/](../../../../README.md) · FINAL_REPORT: [../](../README.md) · Test folder: [../../test_09_bootstrap_ci/](../../test_09_bootstrap_ci/README.md)_
