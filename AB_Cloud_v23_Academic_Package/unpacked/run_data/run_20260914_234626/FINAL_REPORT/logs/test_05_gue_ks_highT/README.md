# `logs/test_05_gue_ks_highT/` — Raw Log Copies of Test 5 (Provenance Set)

This folder is part of FINAL_REPORT's provenance layer: it preserves the **raw computation log and console capture of Test 5** exactly as the reference run wrote them. The reading copies — with the full test description, verdicts and excerpts — live in the test's own folder: [`../../test_05_gue_ks_highT/`](../../test_05_gue_ks_highT/README.md).
...
|---|---|---|
| `computation_log_XX.txt` | 812 B · 10 lines | Timestamped computation log: every log_comp() entry emitted while the test ran, with wall-clock offsets. |
...
---
_Package overview: [unpacked/](../../../../README.md) · FINAL_REPORT: [../](../README.md) · Test folder: [../../test_05_gue_ks_highT/](../../test_05_gue_ks_highT/README.md)_
