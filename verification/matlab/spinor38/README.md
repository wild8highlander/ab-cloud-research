# Test 38 -- 64 spinor structures of the Klein quartic (MATLAB port)

MATLAB port of the validated C++ reference `verification/cpp/spinor38/spinor38.cpp`.
...
## Build and run
    ...
    octave spinor38.m        (Octave)
    % in MATLAB: call spinor38 from the directory (replace exit(1) by error if needed)
...
| `spinor38.m` | 4.7 KB | file |
| **Total (recursive)** | **2 files, 6.0 KB** | |

## ▶ Running — toolchain and entry point

- **Toolchain:** MATLAB R2020b+ or GNU Octave 7+
- **Run:** `spinor38.m   # run inside MATLAB or Octave`
