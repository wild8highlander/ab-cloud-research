# Test 38 -- 64 spinor structures of the Klein quartic (FORTRAN port)

FORTRAN port of the validated C++ reference `verification/cpp/spinor38/spinor38.cpp`.
...
## Build and run
    ...
    gfortran -O2 -o spinor38 spinor38.f90
    ./spinor38 [repo-root]
...
| Entry | Size | Kind |
|---|---|---|
| `README.md` | 1.3 KB | file |
| `spinor38.f90` | 7.3 KB | file |
| **Total (recursive)** | **2 files, 8.6 KB** | |

## ▶ Running — toolchain and entry point

- **Toolchain:** gfortran -O2 -std=f2018 -fcheck=all
- **Run:** `gfortran -O2 -std=f2018 spinor38.f90 -o spinor38 && ./spinor38 [repo-root]`
