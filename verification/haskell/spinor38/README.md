# Test 38 -- 64 spinor structures of the Klein quartic (HASKELL port)

HASKELL port of the validated C++ reference `verification/cpp/spinor38/spinor38.cpp`.
...
| **Total (recursive)** | **2 files, 6.9 KB** | |

## ▶ Running — toolchain and entry point

- **Toolchain:** GHC ≥ 9 — runhaskell or ghc -O2
- **Run:** `runhaskell Main.hs [repo-root]`
