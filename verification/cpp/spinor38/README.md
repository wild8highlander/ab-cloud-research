# Test 38 -- 64 spinor structures of the Klein quartic (CPP port)

CPP port of the validated C++ reference `verification/cpp/spinor38/spinor38.cpp`.
...
| `spinor38.cpp` | 7.6 KB | file |
| **Total (recursive)** | **2 files, 8.8 KB** | |

## ▶ Running — toolchain and entry point

- **Toolchain:** g++ -O2 -std=c++17 — the validated reference implementation
- **Run:** `g++ -O2 -std=c++17 spinor38.cpp -o spinor38 && ./spinor38 [repo-root]`
